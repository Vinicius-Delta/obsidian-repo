...
A adesão da população comum aos dispositivos computadorizados só foi possível devido ao trabalho de comunicação das interfaces gráficas, que realizam a intermerdiação entre a máquina e o usuário. Lembrando que a princípio os computadores eram focados para os profissionais de computação, pois toda interação era feita através de código. A partir da atuação dos designers, a interação com os sistemas foi repensada, possibilidando novas maneiras de *input* e *output*, assim dando origem ao chamado design de interação. (PINHEIRO, 2007, p. 12-13) ^ef32f0

Graças ao design, os computadores e toda Internet se tornou acessível para um nmero maior de usurários. Com o desenvolvimento de desenvolvimento de interfaces gráficas que os sistemas ganham aparência e se torna inteligível, como afima Rafael Cardoso (2012, p. 114): ^4ef0bf
